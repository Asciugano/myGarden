...
public class Terrain {
    ...
    private static final String HEIGHTMAP_PATH = "src/main/resources/heightmap/";
    ...
    private RawModel generateTerrain(Loader loader, String heightMap){
        ...
        try {
            image = ImageIO.read(new File(HEIGHTMAP_PATH + heightMap + ".png"));
        } catch(IOException e) {
            System.out.println("Error loading heightmap: " + HEIGHTMAP_PATH + heightMap + ".png");
        }
